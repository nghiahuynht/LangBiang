#pragma checksum "D:\Projects\OnGit\LangBianSytem\Langbiang_Web\WebApp\Views\TicketOrder\SaleScreen.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4f3e6fb67039173247377a164c1d9c7b940f7a58"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4f3e6fb67039173247377a164c1d9c7b940f7a58", @"/Views/TicketOrder/SaleScreen.cshtml")]
...
#line hidden
            ...
            EndContext();
#line 202 "D:\Projects\OnGit\LangBianSytem\Langbiang_Web\WebApp\Views\TicketOrder\SaleScreen.cshtml"
...
#line hidden
            ...
            EndContext();
            BeginWriteAttribute("onclick", " onclick=\"", 8281, "\"", 8307, 3);
            WriteAttributeValue("", 8291, "clickNum(", 8291, 9, true);
#line 206 "D:\Projects\OnGit\LangBianSytem\Langbiang_Web\WebApp\Views\TicketOrder\SaleScreen.cshtml"
WriteAttributeValue("", 8300, stt, 8300, 6, false);
...
#line hidden
            EndContext();
            BeginContext(8315, 48, true);
            WriteLiteral("</div>\r\n                                </div>\r\n");
            EndContext();
#line 208 "D:\Projects\OnGit\LangBianSytem\Langbiang_Web\WebApp\Views\TicketOrder\SaleScreen.cshtml"
                            }

#line default
#line hidden
            BeginContext(8394, 385, true);
            WriteLiteral(@"                            <div class=""col-sm-3"">
...
");
   ...
   ");
        ...
        function calculaTotal() {
            let quanti = ($(""");
                WriteLiteral(@"#txt-quanti"").val() == """" || $(""#txt-quanti"").val() == null) ? 0 : parseInt($(""#txt-quanti"").val());
        ...
        function GetCustomerByType() {
            ...
            $.ajax({
                type: ""Get"",
                contentType: 'application/json; charset=utf-8',
                url: ""/Customer/GetListCustomerByCustType?customerType="" +");
                WriteLiteral(@" customerType,
...
");
            ...
            if ($(""#txt-quanti"").val() == """" || $(""#txt-quanti"").val() == null) {
                ...
                var modelData = {
                    ...
                    Cu");
                WriteLiteral(@"stomerType: $(""#ddl-customer-type"").val(),
                    ObjType: doituong,
                    PrintType: ""Ve_Le"",
                    Quanti: quanti,
                    Price: price,
                    ...
                    success: function (res) {
                        ...
                        if (res.length > 0) {
                            bootbox.alert(AlertSuccess(""Bán vé thành công, bạn có muốn in không?""), function () {
                                ...
                                //     printPdf(""htt");
                WriteLiteral(@"ps://langbian.gamanjsc.com/ticketorder/GetPDFForPrint/"" + value.subId);
        ...
        //        let quanti = ($(""#txt-quanti"").val() == """);
                WriteLiteral(@""" || $(""#txt-quanti"").val() == null) ? 0 : parseInt($(""#txt-quanti"").val());
        ...
        function selectTicketItem(ticketCode, price, obj) {
            ...
            $(""#hid_Ga");
                WriteLiteral(@"tePrice"").val(price);
