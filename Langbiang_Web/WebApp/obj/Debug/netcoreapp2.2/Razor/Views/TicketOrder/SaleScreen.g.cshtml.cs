#pragma checksum "D:\Projects\OnGit\LangBianSytem\Langbiang_Web\WebApp\Views\TicketOrder\SaleScreen.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "09720705fb529d942d57664bbf3d97b61fc99c7c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"09720705fb529d942d57664bbf3d97b61fc99c7c", @"/Views/TicketOrder/SaleScreen.cshtml")]
 ...
 ");
        ...
        function SaleOrderByGate()
        {
            ...
            else if ($(""#txt-km-percen"").val() == """" || $(""#txt-km-percen"").val() == null)
            {
                ...
                bootbox.alert(Al");
                WriteLiteral(@"ertFail(""Bạn chưa chọn vé bán""));
            }
            else {
      ...
      ");
        ...
        function PrintOrder(pri");
                WriteLiteral(@"ntOption,orderId ,lstTicketSuccess) {
            debugger;
