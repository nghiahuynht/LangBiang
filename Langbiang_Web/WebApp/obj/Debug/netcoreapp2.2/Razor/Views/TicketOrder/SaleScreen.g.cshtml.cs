#pragma checksum "D:\Projects\OnGit\LangBianSytem\Langbiang_Web\WebApp\Views\TicketOrder\SaleScreen.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b4d1b402d2774d89a1be2dcedc328b49a14b1ad4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b4d1b402d2774d89a1be2dcedc328b49a14b1ad4", @"/Views/TicketOrder/SaleScreen.cshtml")]
...
");
                    ...
                    success: function (res) {
                        ...
                        if (res.lstSubCode.length > 0)
                        {
                            ...
                            bootbox.alert(AlertSuccess(""Bán vé thành công, chuẩn bị in vé""), function () {
                                let printOptionVal = $(""#ddl-pr");
                WriteLiteral(@"inttypes"").val();
        ...
        function PrintOrder(printOption,orderId ,lstTicketSuccess) {
            ...
            if (printOption == ""InLe"") {
                $.each(lstTicketSuccess, function (index, value) {
                    //printPdf(""https://langbian.gamanjsc.com/ticketorder/GetPDFForPrint?subId="" + value.subId);
              ...
              ");
                WriteLiteral(@"  //printPdf(""https://langbian.gamanjsc.com/ticketorder/GetPDFForPrint?subId="" + firstRowId);
                printPdf(""http://localhost:44377/ticketorder/GetPDFForPrint?subId="" + firstRowId);
            } else if (printOption == ""InQRCode"") {
                window.open('http://localhost:44377/ticketorder/PrintQRview/' + orderId, '_blank');
            }
        }
        ...
        function printPdf(url) {
            var iframe = document.createElem");
                WriteLiteral(@"ent('iframe');
            // iframe.id = 'pdfIframe'
        ...
        function RenderTotal(data) {
            var res = """";
            if (data !== undefined) {
                res = data.toString().replace(/(\d)(?");
                WriteLiteral("=(\\d{3})+(?!\\d))/g, \'$1,\');\r\n            }\r\n            return res;\r\n        }\r\n    </script>\r\n");
                EndContext();
            }
            );
        }
