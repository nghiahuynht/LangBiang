#pragma checksum "D:\Projects\OnGit\LangBianSytem\Langbiang_Web\WebApp\Views\TicketOrder\SaleScreen.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5635913e25cda202a5fdc751681117c91aa38845"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5635913e25cda202a5fdc751681117c91aa38845", @"/Views/TicketOrder/SaleScreen.cshtml")]
...
");
        ...
        function PrintOrder(printOption,orderId ,lstTicketSuccess) {
            ...
            if (printOption == ""InLe"") {
                $.each(lstTicketSuccess, function (index, value) {
                    //printPdf(""https://langbian.gamanjsc.com/");
                WriteLiteral(@"ticketorder/GetPDFForPrint?subId="" + value.subId);
   ...
   ");
                WriteLiteral(@"         $(""#span-ticket-selected"").html(ticketCode);
